...
namespace Terme.Endpoints.WebUI
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddTransient<IQueryHandler<AllMasterProductQuery,List<MasterProduct>>,AllMasterProductQueryHandler>();
            ...
            services.AddTransient<IMasterProductPhotoCommandRepository, MasterProductPhotoCommandRepository>();
            services.AddTransient<IMasterProductPhotoQueryRepository, MasterProductPhotoQueryRepository>();
            services.AddTransient<CommandHandler<AddMasterProductPhotoCommand>, AddMasterProductPhotoCommandHandler>();
            services.AddTransient<IQueryHandler<AllMasterProductPhotoQuery, List<MasterProductPhoto>>, AllMasterProductPhotoQueryHandler>();
